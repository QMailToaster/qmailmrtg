...
install -Dp %{SOURCE1}  %{buildroot}%{mrtgdir}/qmailmrtg.cfg
install -Dp %{SOURCE2}  %{buildroot}%{basedir}/htdocs/mrtg/index.php
install -Dp %{SOURCE3}  %{buildroot}%{basedir}/include/qmailmrtg.module
