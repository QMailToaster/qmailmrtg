...
install -D qmailmrtg            %{buildroot}%{_bindir}/.
install -D qmailmrtg.cfg        %{buildroot}%{mrtgdir}/.
install -D qmailmrtg.index.php  %{buildroot}%{basedir}/htdocs/mrtg/index.php
install -D qmailmrtg.module     %{buildroot}%{basedir}/include/.
